...
(describe "Currying macro" ;;
          ...
          (it "calls functions with arguments in binding list" ;;
              ...
              (serenade--call-generated-command-with-args (ht-get* (serenade--find-voice-binding "a")
                                                          "command")nil )
              (expect curry-result 
                      :to-equal "a") 
          ...
          (it "calls functions with arguments from speech" ;;
              ...
              (serenade--call-generated-command-with-args (ht-get* (serenade--find-voice-binding "a <x>")
                                                          "command")
                                                 '( ("x" . "q" ) ) ) 
              (expect curry-result 
                      :to-equal "pq")) 
          (it "calls functions with multiple arguments from bindings and speech" ;;
              ...
              (serenade--call-generated-command-with-args (ht-get* (serenade--find-voice-binding "a <x> <y>")
                                                          "command")
                                                 '(( "x" . "c" ) 
                                                   ( "y" . "d" )) ) 
              (expect curry-result 
...
(describe "Serd macro" ;;
          ...
          (it "calls new function with args" ;;
              (serenade-define-speech 'global `(("a <n>" . ,(serd custom-lambda(a) 
                                                                  (setq test-val a) )))) 
              (serenade--call-generated-command-with-args (ht-get* (serenade--find-voice-binding "a <n>")
                                                          "command" ) 
                                                 '(( "n" . "4" ))) 
              (expect test-val 
                      :to-equal 4)))
