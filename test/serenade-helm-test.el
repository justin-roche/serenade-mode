...
(describe "Updates serenade helm M-x map" ;;
          ...
          (it "adds new voice binding for command" (serenade--update-helm-M-x-map "a" 'b) 
              (expect   (ht-get* serenade-helm-M-x-map "b") 
                        :to-equal "a")) 
          (it "adds new voice binding only once" (serenade--update-helm-M-x-map "a" 'b) 
          ...
          (it "adds synonyms" (serenade--update-helm-M-x-map "a" 'b) 
              ...
              (expect   (ht-get* serenade-helm-M-x-map "b") 
                        :to-equal "c | a")) 
          (it "adds synonyms only once" (serenade--update-helm-M-x-map "a" 'b) 
              (serenade--update-helm-M-x-map "c" 'b) 
              (serenade--update-helm-M-x-map "a" 'b) 
              (serenade--update-helm-M-x-map "c" 'b) 
              (expect   (ht-get* serenade-helm-M-x-map "b") 
                        :to-equal "c | a")) 
          (it "adds similar synonyms" (serenade--update-helm-M-x-map "a b" 'b) 
              (serenade--update-helm-M-x-map "a c b" 'b) 
              (expect   (ht-get* serenade-helm-M-x-map "b") 
                        :to-equal "a c b | a b")) 
